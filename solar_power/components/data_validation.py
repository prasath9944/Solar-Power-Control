...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            logging.info(f"test_df_columns: {len(test_df.columns)}")
            logging.info(f"test_df_columns: {test_df.columns}")
            logging.info(f"base_df_columns:{len(base_df.columns)}")            
            logging.info(f"base_df_columns: {base_df.columns}")
            logging.info(f"train_df_columns:{len(train_df.columns)}")
            logging.info(f"train_df_columns: {train_df.columns}")
