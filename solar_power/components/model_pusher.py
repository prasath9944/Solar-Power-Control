...
from solar_power.entity.config_entity import ModelPusherConfig
from solar_power.exception import SolarException
import os,sys
from solar_power.utils import load_object,save_object
from solar_power.logger import logging
from solar_power.entity.artifact_entity import DataTransformationArtifact,ModelTrainerArtifact,ModelPusherArtifact
class ModelPusher:
